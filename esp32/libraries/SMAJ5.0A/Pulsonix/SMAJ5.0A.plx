...
//556564/858662/2.49/2/3/TVS Diode Uni-directional
...
(library Library_1
	...
	(symbolDef "SMAJ5.0A" (originalName "SMAJ5.0A")
	...
	(compDef "SMAJ5.0A" (originalName "SMAJ5.0A") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SMAJ5.0A"))
		...
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Littelfuse/SMAJ50A?qs=2VFNtWizgicfetZVA4gWHA%3D%3D")
		(attr "Arrow Part Number" "SMAJ5.0A")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/smaj5.0a/littelfuse?region=nac")
		...
		(attr "<STEP Filename>" "SMAJ5.0A.stp")
